...
import './contacts.css';
import { FaXTwitter, FaLocationDot, FaInstagram, FaFacebookF, FaLinkedinIn} from "react-icons/fa6";
...
const contactTranslations = {
  ...
  fr: {
    ...
    ptext2:"Nous créerons du contenu de qualité et établirons au moins 40 liens de haute autorité vers chaque actif, vous aidant ainsi à améliorer votre classement et vos marques.",
  ...
  es: {
    ...
    ptext2:"W  Crearemos contenido de alta calidad y generaremos al menos 40 enlaces de alta autoridad para cada activo, ayudándote a mejorar tus clasificaciones y marcas.",
  ...
  de: {
    ...
    ptext2:" Wir erstellen hochwertigen verlinkbaren Inhalt und bauen mindestens 40 hochwertige Links zu jeder Ressource auf, um Ihr Ranking und Ihre Marken zu verbessern.",
        ...
        <div className="insidecontact">
            <div className="locate">
                ...
                <div className="contact11">
                   <a href="#"> <FaLocationDot  className="icons" /> </a>
                   <p>{c.pimo}</p>
                </div> 
                <div className="contact11">
        ...
        <div className="mymap">
          {/*    <LoadScript googleMapsApiKey={REACT_GOOGLE_MAPS_API_KEY}>
               ...
               <div style={{ width: "100%", height: "400px"}}>
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15895.385170900116!2d7.3866013!3d5.1284495!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x10429939ea6214b5%3A0xa991cd2fbdbaef96!2sJenga%20Tech%20Institute!5e0!3m2!1sen!2sng!4v1738105527916!5m2!1sen!2sng" width="100%" height="400px" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
