...
import './Footer.css'
import {  FaXTwitter, FaInstagram, FaFacebookF, FaLinkedinIn, FaRegCopyright } from "react-icons/fa6";
         ...
         <div className="insidefot">
          <div className="insidefot1">
            ...
            <div className="surcrib">
             ...
             <button onClick={handelSubmit}><a href="https://www.youtube.com/@DestinMarvel"> {t.subscribeButton}</a></button>
            </div>
          </div>
        ...
        {/*    <a onClick={() => handleOpenContent("Pricing")}>{t.pricing}</a>
          ...
          <div className="insidefot4">
           ...
           <div className="contact">
            <a href="#"><PiPhoneCallFill  className="icons"/></a>
            <p>+234-242-631-21</p>
            </div>

            <div className="contact1">
            <a href="#"> <MdOutlineEmail className="icons" /> </a>
            <a href="#"> <p> Youremailed.com</p></a>
            </div>    

            <div className="contact2">
              <a href="https://x.com/Lucasaustin07?t=3h69RvXOq4URAfd_ymtMnw&s=09"><FaXTwitter className="icons "/></a>
              <a href="https://www.instagram.com/marvel0490?igsh=YzljYTk1ODg3Zg=="><FaInstagram className="icons "/></a>
              <a href="https://www.facebook.com/profile.php?id=100073069950448"><FaFacebookF className="icons "/></a>
              <a href="https://www.linkedin.com/in/destin-marvel-29721427a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"><FaLinkedinIn className="icons "/></a>
      ...
      {activeContent && (
          <div className="sliding-panal">
             <div className="pabel-header">
               <h2>{activeContent}</h2>
               <button className="close-btn" onClick={handleCloseContent}>&times;</button>
             </div>
                  ...
                  <div className="faq1">
                    <ul className="roll">
                        ...
                        <li className='li1'>
                          ...
                          <label className='label0' htmlFor="first0">Can you customize a project based on my specific requirements?
                          </label>
                        <div className="content0">Absolutely! Each project I take on is customized to meet the client's unique goals and requirements.
                        ...
                        <li  className='li2'>
                          ...
                          <label className='label1' htmlFor="first1">What services do you offer </label>
                        <div className="content1">I specialise in [Web-development, Programming, Software-engineering, App-Development, content-Writing ].
                          Additional, I offer custom solution tailored to meet your specfic needs
                           </div>
                        </li>
                       ...
                       <input type="radio" name='roll' id='first3' />
                        ...
                        <input type="radio" name='roll' id='first5' />
                          <label className='label5' htmlFor="first5">How long will it take to complete the project</label>
                        <div className="content5">The timeline varies based on the project size and requirements. For smaller projects, it could take 1–2 weeks,
                           while larger ones may take several weeks or months. Let’s discuss your needs to provide a more accurate estimate.</div>
                         </li>
...
Cookies are little text files that are stored within your browser’s cache. First and third-party cookies are used on this site for functionality, statistics, and advertising.
</div>
                    </div>
...
You can also disable cookies on your device by changing your browser’s settings. You have the option to use opt-out programs like, "NAI’s Consumer opt-out" or "Google Analytics opt-out browser add-on". These prevent cookies from being used in your browser. Know that if you do this, our site may not function properly.
                    ...
                    <div className="polic4">
                       <div className="inspo1">What third-parties do we share your information with?</div>
                       <div className="inspo2">
 ...
 Cookies will also gather session information like the pages viewed, the amount of time spent in the session, transactions, and any other general demographic information (origin, gender, age).
                ...
                {activeContent === "Terms & Conditions" && (
                  ...
                  <div className="knownow">
                    ...
                    <div className="now3">
                      <h2>Definitions/ Terminology
                      </h2>
                      <p>The following definitions apply to these Terms and Conditions, Privacy Statement, 
                        Disclaimer Notice and all Agreements: "User", "Visitor", "Client", "Customer", 
                        "You" and "Your" refers to you, the person(s) that use this Website. "[DMZPortfolioWebsite]",
                         "We", "Our" and "Us", refers to our Website/Company. "Party", "Parties," or "Us" refers 
                    ...
                    <div className="now4">
                      ...
                      <p> Ohter than the content you own and opted to include on this Website, Under these Terms,
                        [DMZPortfolioWebsite] and/or its license own and reserve all intellectual property rights of this
                         Website. You are granted a limited license, subject to the restrictions entailed in these Terms 
                         and Condition, for purpose of viewing this Website content.
                      </p>
                    </div>
                      ...
                      <div className="why-choose-us">
                        <div className="choose1">
                             <div className="one-choose">
                              <p>Achieving 99.8% success in my projects is not just a number—it’s a reflection of my dedication,
                                 skills, and commitment to delivering high-quality work. Every project I undertake is approached 
                                 with a clear strategy, efficient problem-solving, and a strong focus on client satisfaction. 
                        ...
                        <img src="/public/image/IMG_20240702_220919_784.jpg" alt="" />
                              <h1>98% <br /> On-Time Rate</h1>
                                   ...
                                   <p>Meeting deadlines is a crucial part of my work ethic. With a 98% on-time rate, 
                                    I ensure that every project is completed efficiently without compromising on quality. 
                                    Time management and organization are key factors that contribute to my ability to deliver 
                                    work punctually. From the initial planning stages to the final deployment, I follow a structured 
                                    workflow that helps me stay on track and anticipate potential challenges.{/*} Effective communication
                          ...
                          <h1>300+ <br /> Deliveries</h1>
                          <p>With over 300 satisfied clients, my work speaks for itself. Every project I work on is tailored to meet specific client needs, ensuring that their vision is brought to life in the best possible way. 
                            I focus not just on writing code but on providing complete solutions that help businesses .</p>
                              </div>
                              </div>
                      </div>
                    </div>
